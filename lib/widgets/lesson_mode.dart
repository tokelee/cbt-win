...
class LessonMode extends StatelessWidget {
  final dynamic onStandardTap;
  final dynamic onCustomizeTap;
  const LessonMode({super.key, required this.onStandardTap, required this.onCustomizeTap});
